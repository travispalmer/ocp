...
cd /home/$SUDOUSER && git clone https://github.com/travispalmer/ocp.git
cp /home/$SUDOUSER/ocp/msftAad.crt /tmp/msftAad.crt
...
runuser -l $SUDOUSER -c "oc adm groups new clusteradmins $CLUSTERADMINS"
